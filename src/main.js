...
let two_day_signature = new Product('Two_Day_Signature','Дводневен signature',2000)
let three_day_signature = new Product('Three_Day_Signature','Тридневен signature',2850)
let four_day_signature = new Product('Four_Day_Signature','Четиридневен signature',3600)
///
...
let four_day_immuno = new Product('Four_Day_Immuno','Четиридневен immuno',3400)
